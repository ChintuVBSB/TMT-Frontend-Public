...
function StaffReport() {
  ...
  <>
    ...
    <div className="p-6 pt-20 max-w-6xl mx-auto  text-gray-800 space-y-8" id="report-container">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white p-4 rounded shadow text-center">
          <h3 className="text-sm font-medium text-gray-500">Recurring Tasks</h3>
       ...
       <div className="flex flex-col gap-22 justify-star md:flex-row items-center gap-6">
        <img
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded shadow">
          <h3 className="text-lg font-semibold mb-4 text-center">Monthly Task Chart</h3>
          <div className="h-64">
            <Bar
              data={{
                labels: report.monthlyChart.map((item) => item.week || "Week"),
                datasets: [
                  {
                    label: "Tasks",
        ...
        <div className="bg-white p-6 rounded shadow">
          <h3 className="text-lg font-semibold mb-4 text-center">Weekly Task Chart</h3>
          <div className="h-64">
            <Line
              data={{
